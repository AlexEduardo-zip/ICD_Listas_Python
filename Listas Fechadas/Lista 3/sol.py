...
Original file is located at
    https://colab.research.google.com/drive/179ELjhg7qqoCvjt875kqa83nemCqLeuo
...
def high_delay(df):
    ...
    good.loc[idx_same_day, 'Q5'] = good.CRSArrTime - good.CRSDepTime          # tempo de voos diurnos
    good.loc[~idx_same_day, 'Q5'] = 2400 - good.CRSDepTime + good.CRSArrTime  # tempo de voos que viram a noite
    good = good[['OriginAirportName', 'DestAirportName', 'Q5']]            # seleciona as colunas de interesse
    good = good.groupby(['OriginAirportName', 'DestAirportName']).mean()         # agrupa por aeroportos
    good = good.sort_values('Q5', ascending=False)                         # ordena por tempo de voo
    tuple = good.index[0]
    return tuple
...
df.boxplot(column='DepDelay', by='DayOfWeek' , grid=False,showfliers=False)  # mostra os outliers
